package bmx.example.kike.VolleyEnAndroid;
...
import com.example.jorge.VolleyEnAndroid.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadImage(String url){
        ...
        imageLoader = MyVolley.getInstance(this.getApplicationContext()).getImageLoader();
